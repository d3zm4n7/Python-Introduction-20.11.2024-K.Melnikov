...
# Поля ввода (Entries)
ent_emailto = Entry(window, width=40)
ent_emailto.grid(row=0, column=1, columnspan=4, padx=5, pady=5, sticky="ew")

ent_sub = Entry(window, width=40)
ent_sub.grid(row=1, column=1, columnspan=2, padx=5, pady=5, sticky="ew")

ent_attach = Label(window, text="...", font=("Times New Roman", 10, "bold"), width=30)
ent_attach.grid(row=2, column=1, padx=5, pady=5, sticky="ew")



# Поле для ввода текста письма (Text)
txt_message = Text(window, width=40, height=5)
txt_message.grid(row=3, column=1, columnspan=2, padx=5, pady=5, sticky="ew")
